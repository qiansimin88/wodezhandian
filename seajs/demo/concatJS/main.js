...
//上线的版本 ，比如合并操作：define要多出两个参数：第一个参数 ：当前模块的ID ，第二个参数：依赖模块的数组(没有依赖模块就写空数组)
...
define('./main.js',['./dragModule.js'],function(require,exports,module){
...
// JavaScript Document
//拖拽接口  为drag
define('./dragModule.js',['./range.js'],function(require,exports,module){
