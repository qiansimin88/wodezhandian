document.write("<div id='meizzCalendarLayer' name='meizzCalendarLayer' style='position: absolute; z-index: 9999; width: 179px; height: 193px; display: none'>");
...
function writeIframe() {
    ...
    "*{font-size: 12px; font-family: 宋体;color: #FFFFFF;font-weight: bolder;font-weight: bold;}" +
    ".bg{color: " + WebCalendar.lightColor + "; cursor: default; background-color: " + WebCalendar.darkColor + ";}" +
    "table#tableMain{ width: 177; height: 180;}" +
    "table#tableWeek td{ color: " + WebCalendar.lightColor + ";}" +
    "table#tableDay  td{ font-weight: bold;}" +
    "td#meizzYearHead, td#meizzYearMonth{color: " + WebCalendar.wordColor + "}" +
    ".out { text-align: center;border-top: 0px solid " + WebCalendar.DarkBorder + "; border-left: 0px solid " + WebCalendar.DarkBorder + ";" +
    "border-right: 0px solid " + WebCalendar.lightColor + "; border-bottom: 0px solid " + WebCalendar.lightColor + ";}" +
    ".over{ text-align: center;border-top: 0px solid #FFFFFF; border-left: 0px solid #FFFFFF;" +
    "border-bottom: 0px solid " + WebCalendar.DarkBorder + "; border-right: 0px solid " + WebCalendar.DarkBorder + "}" +
    "input{ border: 1px solid " + WebCalendar.darkColor + "; padding-top: 1px; height: 18; cursor: hand;" +
    " color:#b3c5d3; background-color: " + WebCalendar.btnBgColor + "}" +
    ...
    "<tr><td width=175 height=19 bgcolor='" + WebCalendar.lightColor + "'>" +
    "    <table width=175 id=tableHead border=0 cellspacing=1 cellpadding=0><tr align=center>" +
    "    <td width=25 height=19 class=bg title='向前翻 1 月快捷键：←' style='cursor: hand' onclick='parent.prevM()'><b>&lt;</b></td>" +
    ...
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'" +
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>" +
    "    <td width=25 class=bg title='向后翻 1 月快捷键：→' onclick='parent.nextM()' style='cursor: hand'><b>&gt;</b></td></tr></table>" +
    "</td></tr><tr><td height=20><table id=tableWeek border=0 width=175 cellpadding=0 cellspacing=0 ";
    ...
    "</td></tr><tr><td valign=top width=175 bgcolor='" + WebCalendar.lightColor + "'>" +
    "    <table id=tableDay height=120 width=175 border=0 cellspacing=1 cellpadding=0>";
    for (var x = 0; x < 5; x++) {
        strIframe += "<tr>";
    ...
    strIframe += "<td colspan=3 class=out><input style=' background-color: " +
         WebCalendar.btnBgColor + ";cursor: hand; padding-top: 2px; width: 100%; height: 100%; border: 0' onfocus='this.blur()'" +
         " type=button value='&nbsp;清空&nbsp;' onclick='parent.emptying()'></td></tr></table>" +
    "</td></tr><tr><td height=20 width=178 bgcolor='" + WebCalendar.lightColor + "'>" +
    "    <table border='0' cellpadding=1 cellspacing=0 width=175>" +
    "    <tr><td><input  style='width: 24' name=prevYear title='向前翻 1 年快捷键：↑' onclick='parent.prevY()' type=button value='&lt;&lt;'" +
    "    onfocus='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==1000)'><input  style='width: 24' " +
    "    onfocus='this.blur()' name=prevMonth title='向前翻 1 月快捷键：←' onclick='parent.prevM()' type=button value='&lt;&nbsp;'>" +
    "    </td><td align=center><input name=today type=button value='今天' onfocus='this.blur()' style='width: 69' title='当前日期快捷键：T'" +
    "    onclick=\"parent.returnDate(event,new Date().getDate() +'/'+ (new Date().getMonth() +1) +'/'+ new Date().getFullYear())\">" +
    "    </td><td  align=right><input  style='width: 24'  title='向后翻 1 月快捷键：→' name=nextMonth onclick='parent.nextM()' type=button value='&nbsp;&gt;'" +
    "    onfocus='this.blur()'><input  style='width: 24'  name=nextYear title='向后翻 1 年快捷键：↓' onclick='parent.nextY()' type=button value='&gt;&gt;'" +
